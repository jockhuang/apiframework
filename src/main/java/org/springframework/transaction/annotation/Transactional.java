...
public @interface Transactional {
	 ...
	 * bean definition.
	 */
	String value() default "singleTx";
	DataShardTypeEnum dataShardType() default DataShardTypeEnum.merchant;
	ShardTypeEnum shardType() default ShardTypeEnum.mod;
	String readOrWrite() default Constants.READ_DB;
	String shardKey() default "1";
	boolean shardFlag() default false;
