...
public abstract class TransactionSynchronizationManager {
	...
	private static final ThreadLocal<DataSourceTransactionManager> currentTransactionManager =
			new NamedThreadLocal<DataSourceTransactionManager>("Current transaction manager");
	...
	public static void setCurrentTransactionManager(DataSourceTransactionManager manager) {
		currentTransactionManager.set(manager);
	}
	public static DataSourceTransactionManager getCurrentTransactionManager() {
		return currentTransactionManager.get();
	}
