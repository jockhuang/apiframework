...
public abstract class DataSourceUtils {
	...
	public static Connection doGetConnection(DataSource dataSource) throws SQLException {
		...
		DataSourceTransactionManager manager = TransactionSynchronizationManager.getCurrentTransactionManager();
		ConnectionHolder conHolder = (ConnectionHolder) TransactionSynchronizationManager.getResource(dataSource);
		if ((manager!=null||(!(dataSource instanceof AbstractRoutingDataSource))) && (conHolder != null) && (((conHolder.hasConnection()) || (conHolder.isSynchronizedWithTransaction())))) {
			conHolder.requested();
		...
		if (((conHolder == null) && (TransactionSynchronizationManager.isSynchronizationActive())) || ((!(dataSource instanceof AbstractRoutingDataSource)) && (TransactionSynchronizationManager.isSynchronizationActive()))) {
