...
public class FtpServerFactory {
     ...
     * 
     * @param listeners The listeners to use for this server with the name as the key and the listener as the value
    ...
    /**
     * Set the {@link Ftplet}s to be active by servers created by this factory. Replaces existing {@link Ftplet}s
     * 
     * @param ftplets Ftplets as a map with the name as the key and the Ftplet as the value. The Ftplet container will
     *            iterate over the map in the order provided by the Map. If invocation order of Ftplets is of
     ...
     * 
     * @param connectionConfig The {@link ConnectionConfig} to be used by servers created by this factory
     * 
     * @param messageResource The {@link MessageResource}
     * @throws IllegalStateException If a custom server context has been set
     */
