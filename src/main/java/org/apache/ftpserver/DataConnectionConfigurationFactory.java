...
public class DataConnectionConfigurationFactory {
    ...
    /**
     * Create a {@link DataConnectionConfiguration} instance based on the configuration on this factory
     * 
     * @return The {@link DataConnectionConfiguration} instance
     */
    public DataConnectionConfiguration createDataConnectionConfiguration() {
        checkValidAddresses();
        return new DefaultDataConnectionConfiguration(idleTime, ssl, activeEnabled, activeIpCheck, activeLocalAddress,
                activeLocalPort, passiveAddress, passivePorts, passiveExternalAddress, implicitSsl);
    }

    /*
     * (Non-Javadoc) Checks if the configured addresses to be used in further data connections are valid.
     */
    ...
    /**
     * Set the passive ports to be used for data connections. Ports can be defined as single ports, closed or open
     * ranges. Multiple definitions can be separated by commas, for example:
     * <ul>
