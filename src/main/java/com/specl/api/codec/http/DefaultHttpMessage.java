...
public class DefaultHttpMessage implements MutableHttpMessage {
    ...
    private final Set<Cookie> cookies = new TreeSet<Cookie>(CookieComparator.INSTANCE);
    ...
    public void setKeepAlive(boolean keepAlive) {
        setHeader(HttpHeaderConstants.KEY_CONNECTION, keepAlive ? HttpHeaderConstants.VALUE_KEEP_ALIVE
