...
public class HttpResponseStatus implements Serializable {
    ...
    public static final HttpResponseStatus CONTINUE = new HttpResponseStatus(100, "Continue", true, false);
    ...
    public static final HttpResponseStatus NON_AUTHORITATIVE = new HttpResponseStatus(203,
            "Non-Authoritative Information", true, false);
    ...
    public static final HttpResponseStatus PROXY_AUTHENTICATION_REQUIRED = new HttpResponseStatus(407,
            "Proxy Authentication Required", true, false);
    ...
    public static final HttpResponseStatus REQUEST_RANGE_NOT_SATISFIABLE = new HttpResponseStatus(416,
            "Requested range not satisfiable", true, false);
    ...
    public static final HttpResponseStatus GATEWAY_TIMEOUT = new HttpResponseStatus(504, "Gateway Time-out", true,
            false);
    ...
    /**
     * @return <code>true</code> iff a message body may be transmitted in a response containing this response status
     */
    ...
    /**
     * @return <code>true</code> iff a connection which would normally be kept alive should be closed as a result of
     *         this response
     */
    ...
    /**
     * Returns the <code>ResponseStatus</code> with the specified status id. If no status exists with the specified id,
     * a new status is created and registered based on the category applicable to the id:<br/>
     * <table border="1">
     * <tr>
     * <td>100 - 199</td>
     * <td>Informational</td>
    ...
    /**
     * Obtains the response category which covers the specified response id
     * 
     * @param id The id
     * @return The category - or <code>null</code> if no category covers the specified response id
     */
    ...
    private HttpResponseStatus(int code, String description, boolean allowsMessageBody, boolean forcesConnectionClosure) {
    ...
    public static enum Category {
        ...
        /**
         * Indicate that the server is aware that it has erred or is incapable of performing the request
         */
        SERVER_ERROR(true), ;
